...
def get_filters():
    ...
    #I used following simple example to help me: https://www.includehelp.com/python/asking-the-user-for-input-until-a-valid-response-in-python.aspx
    while True:
     try:
    ...
    # get user input for day of week (all, monday, tuesday, ... sunday)
        ...
        month = 'all'
        break;
      #if the user does not choose to filter by month or day, then no matter what asnwer is, there will be no filter:   
      else:
...
def user_stats(df):
    ...
    # Display counts of gender and create an exception for cities with no gender info like washington!'
    while True:
     try:
